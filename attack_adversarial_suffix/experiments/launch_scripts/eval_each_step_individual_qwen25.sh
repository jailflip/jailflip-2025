#!/bin/bash
export model=qwen25 # qwen25 or llama31


file_list=(
    # TODO: fill in your log files path, just like this
    # '../results_qwen25_individual/offset0_seed2025_20250101-12:01:01/jailflip_result_qwen25_n1_seed2025_offset0.json'
    # '../results_qwen25_individual/offset1_seed2025_20250101-12:02:01/jailflip_result_qwen25_n1_seed2025_offset0.json'
    # ...
)
...
do
    python -u ../evaluate_each_step_individual_qwen25.py \
